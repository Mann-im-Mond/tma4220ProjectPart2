...
\end{align*}
From now on we assume that $a$ is bounded and coerzive and that $L$ is bounded. This will assure that we can use Lax-Milgram \cite{quarteroni2009numerical} and that thereby the heat equation has a unique solution.
